...
var _c0 = ["contentRef"];
var _c1 = ["*"];
var _DragScrollItemDirective = class _DragScrollItemDirective {
  get dragDisabled() {
...
_DragScrollItemDirective.ɵfac = function DragScrollItemDirective_Factory(t) {
  return new (t || _DragScrollItemDirective)(ɵɵdirectiveInject(ElementRef));
};
_DragScrollItemDirective.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    dragDisabled: [InputFlags.None, "drag-disabled", "dragDisabled"]
  },
  standalone: true
});
var DragScrollItemDirective = _DragScrollItemDirective;
(() => {
...
var _DragScrollComponent = class _DragScrollComponent {
  /**
...
_DragScrollComponent.ɵfac = function DragScrollComponent_Factory(t) {
  return new (t || _DragScrollComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(DOCUMENT));
};
_DragScrollComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    scrollbarHidden: [InputFlags.None, "scrollbar-hidden", "scrollbarHidden"],
    disabled: [InputFlags.None, "drag-scroll-disabled", "disabled"],
    xDisabled: [InputFlags.None, "drag-scroll-x-disabled", "xDisabled"],
    yDisabled: [InputFlags.None, "drag-scroll-y-disabled", "yDisabled"],
    xWheelEnabled: [InputFlags.None, "scroll-x-wheel-enabled", "xWheelEnabled"],
    dragDisabled: [InputFlags.None, "drag-disabled", "dragDisabled"],
    snapDisabled: [InputFlags.None, "snap-disabled", "snapDisabled"],
    snapOffset: [InputFlags.None, "snap-offset", "snapOffset"],
    snapDuration: [InputFlags.None, "snap-duration", "snapDuration"]
  },
  outputs: {
...
var DragScrollComponent = _DragScrollComponent;
(() => {
